...
import java.io.*;
import java.sql.*;
	public class Rstudentd extends JFrame implements ActionListener {
		JLabel u1,u2,u3,u4;
		JTextField y1,y2;
		Conn cu;
		
		String an,b,n,o;
		int fee,sno1,sno2,sno3,sno4,sno5,sno6,sno8,sno9,sno10,sno11,sno13;
		JComboBox c,m;
		JPanel y;
		JButton l;
		ResultSet umu;
...
//			return "notfound";
//		}
	public Rstudentd(String af,String bf) {
					...
					FileInputStream ml = new FileInputStream("F:\\bus2.txt");
			     	DataInputStream yy = new DataInputStream(ml);
			     	   line =yy.readLine();
			     		...
			     		stops=item;
			     		setVisible(false);
			     		new Rstudent1(stops,n,sno2,an,b).setVisible(true);
					...
					FileInputStream ml = new FileInputStream("F:\\bus3.txt");
			     	DataInputStream yy = new DataInputStream(ml);
			     	   line =yy.readLine();
			     		...
			     		stops=item;
			     		setVisible(false);
			     		new Rstudent1(stops,n,sno3,an,b).setVisible(true);
		...
		FileInputStream ml = new FileInputStream("F:\\bus4.txt");
     	...
     	DataInputStream yy = new DataInputStream(ml);
     	   line =yy.readLine();
     		...
     		stops=item;
     		setVisible(false);
     		new Rstudent1(stops,n,sno4,an,b).setVisible(true);
	...
	try {
		...
		while(c.rs.next()) {
			sno5=Integer.parseInt(c.rs.getString("sno"));
		...
		FileInputStream ml = new FileInputStream("F:\\bus5.txt");
     	DataInputStream yy = new DataInputStream(ml);
     	   line =yy.readLine();
     		...
     		stops=item;
     		setVisible(false);
     		new Rstudent1(stops,n,sno5,an,b).setVisible(true);
		...
		FileInputStream ml = new FileInputStream("F:\\bus6.txt");
     	DataInputStream yy = new DataInputStream(ml);
     	   line =yy.readLine();
     		...
     		stops=item;
     		setVisible(false);
     		new Rstudent1(stops,n,sno6,an,b).setVisible(true);
		...
		FileInputStream ml = new FileInputStream("F:\\bus8.txt");
     	DataInputStream yy = new DataInputStream(ml);
     	   line =yy.readLine();
     		...
     		stops=item;
     		setVisible(false);
     		new Rstudent1(stops,n,sno8,an,b).setVisible(true);
		...
		FileInputStream ml = new FileInputStream("F:\\bus9.txt");
     	DataInputStream yy = new DataInputStream(ml);
     	   line =yy.readLine();
     		...
     		stops=item;
     		setVisible(false);
     		new Rstudent1(stops,n,sno9,an,b).setVisible(true);
		...
		FileInputStream ml = new FileInputStream("F:\\bus10.txt");
     	DataInputStream yy = new DataInputStream(ml);
     	   line =yy.readLine();
     		...
     		stops=item;
     		setVisible(false);
     		new Rstudent1(stops,n,sno10,an,b).setVisible(true);
		...
		FileInputStream ml = new FileInputStream("F:\\bus11.txt");
     	DataInputStream yy = new DataInputStream(ml);
     	   line =yy.readLine();
     		...
     		stops=item;
     		setVisible(false);
     		new Rstudent1(stops,n,sno11,an,b).setVisible(true);
		...
		FileInputStream ml = new FileInputStream("F:\\bus13.txt");
     	DataInputStream yy = new DataInputStream(ml);
     	   line =yy.readLine();
     		...
     		new Rstudent1(stops,n,sno13,an,b).setVisible(true);
     		setVisible(false);
